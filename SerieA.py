...
trophies=[]
winners=[]
ucl=["Manchester City","Chelsea","Liverpool","Manchester City","Chelsea","Liverpool", "Bayern Munich","Arsenal","Manchester United","Tottenham Hotspur", "Bayern Munich", "Paris St. Germain", "Real Madrid", "Barcelona","Real Madrid", "Barcelona", "Borrusia Dortmund", "Atletico Madrid"]
...
def clubworld(winners):
    clubteams=["Manchester City","Chelsea","Manchester City","Chelsea","Manchester City","Chelsea","Al Ahly","Waydad Casablanca","Monterrey","Leon","Pachuca","Seattle Sounders","Al-Hilal","Al Ain","Urawa Red Diamonds","Ulsan HD","Flamengo","Palmeiras","Fluminense","River Plate","Flamengo","Palmeiras","Fluminense","River Plate","Borussia Dortmund","Bayern Munich","Atletico Madrid","Real Madrid","Paris St. Germain","Borussia Dortmund","Bayern Munich","Atletico Madrid","Real Madrid","Paris St. Germain"]
    
    year=2023+season
    if year==2025:
        clubteams.append('Inter Milan')
        clubteams.append('Juventus')
        clubteams.append('Inter Milan')
        clubteams.append('Juventus')
        clubteams.append('Inter Milan')
        clubteams.append('Juventus')
...
teams = ["AC Milan","Atalanta","Bologna","Cagliari","Como","Empoli","Fiorentina","Genoa","Hellas Verona","Inter Milan","Juventus",
         "Lazio","Lecce","Monza","Napoli","Parma","Roma","Torino","Udinese","Venezia"
]
startteams = ["Cagliari","Como","Empoli","Genoa","Hellas Verona","Lecce","Monza","Parma","Torino","Venezia"
]
...
your=[]
stadiums = ["San Siro","Gewiss Stadium","Stadio Renato Dall'Ara","Unipol Domus","Stadio Giuseppe Sinigaglia","Stadio Carlo Castellani",
            "Stadio Artemio Franchi","Stadio Luigi Ferraris","Stadio Marcantonio Bentegodi","San Siro","Juventus Stadium",
            "Stadio Olimpico","Stadio Via del mare","Stadio Brianteo","Stadio Diego Armando Maradona","Stadio Ennio Tardini",
            "Stadio Olimpico","Stadio Olimpico Grande Torino","Stadio Friuli","Stadio Pier Luigi Penzo"
]

relteams =['Frosinone','Sassuolo','Salernitana','Spezia','Cremonese']
relteamsorg =['Frosinone','Sassuolo','Salernitana','Spezia','Cremonese']
relstadiums=['Stadio Benito Stirpe','	Mapei Stadium – Città del Tricolore','Stadio Arechi','Stadio Alberto Picco','Stadio Giovanni Zini']
fateams=[]
carabao=[]
bigsix=["Inter Milan","AC Milan","Juventus","Napoli","Roma","Lazio"]
good=["Inter Milan","AC Milan","Juventus","Napoli","Roma","Lazio"]
print("Welcome to the Serie A Football Game!")
old=0
...
def nationalchoose():
     ...
     can=1
     nationalstart=['Argentina','Brazil','France','Germany','Italy','Spain']
...
while True:
    ...
    while count<39:
            ...
            if your_team=="Inter Milan" or your_team=="AC Milan" or your_team=="Napoli" or your_team=="Juventus":
                your_team_score=random.randint(0,7)
            if computer_team=="Inter Milan" or computer_team=="AC Milan" or computer_team=="Napoli" or computer_team=="Juventus":
                computer_team_score=random.randint(0,6)
            if your_team=="Roma"  or your_team=="Atalanta" or your_team=="Lazio" or your_team=="Fiorentina" or your_team=="Bologna":
                your_team_score=random.randint(0,6)
            if computer_team=="Roma" or computer_team=="Atalanta" or computer_team=="Lazio" or computer_team=="Fiorentina" or your_team=="Bologna":
                computer_team_score=random.randint(0,5)
            if your_team=="Parma" or your_team=="Como" or your_team=="Venezia" or your_team=="Hellas Verona" or your_team in relteamsorg:
                your_team_socre=random.randint(0,3)
            if computer_team=="Parma" or computer_team=="Como" or computer_team=="Venezia" or computer_team=="Hellas Verona" or computer_team in relteamsorg:
            ...
            if count==38:
              if season==1:
                    totgoal=[]
                    totassists=[]
                    ucl=["Manchester City","Chelsea","Liverpool","Manchester City","Chelsea","Liverpool", "Bayern Munich","Arsenal",
                   "Manchester United","Tottenham Hotspur", "Bayern Munich", "Paris St. Germain", "Real Madrid", "Barcelona",
                   "Real Madrid", "Barcelona", "Borrusia Dortmund", "Atletico Madrid"]
              
              
              
                    uel=["Rangers","Celtic","Real Betis","Sevilla","Ajax","Bayer Leverkusen","Aston Villa","Sporting CP","Olympiacos ","AEK Athens","Slavia Prague",
                   "Brighton & Hove Albion","Marseille","Rangers","Celtic","Real Betis","Sevilla","Ajax","Bayer Leverkusen","Aston Villa","Brighton & Hove Albion","Marseille"]
              ...
              fa=["AC Milan","Atalanta","Bologna","Cagliari","Como","Empoli","Fiorentina","Genoa","Hellas Verona","Inter Milan","Juventus",
         "Lazio","Lecce","Monza","Napoli","Parma","Roma","Torino","Udinese","Venezia","AC Milan","Atalanta","Bologna","Cagliari","Como","Empoli","Fiorentina","Genoa","Hellas Verona","Inter Milan","Juventus",
         "Lazio","Lecce","Monza","Napoli","Parma","Roma","Torino","Udinese","Venezia",'Frosinone','Sassuolo','Salernitana','Spezia','Cremonese']
              ...
              for team in teams:
                    c=count-1
                    if team=="Inter Milan" or team=="AC Milan" or team=="Napoli" or team=="Juventus":
                         wins = random.randrange(23, 30)
                         x=37-wins
                         losses = random.randrange(2,  x)
              ...
              if season>1:
                  ...
                  one=["Inter Milan","AC Milan","Lazio","Roma","Juventus","Napoli"]
                  carabao_winner=random.choice(one)
              ...
              if your_team==epl_winner:
                  trophies.append(f"{year} Serie A")
                  print("Congratulations, you have won the Serie A!")             
              if your_team==fa_winner:
                  trophies.append(f"{year} Coppa Italia")
                  print("Congratulations, you have won the Coppa Italia!")
              if your_team==carabao_winner:
                  trophies.append(f"{year} Supercoppa Italiana")
                  print("Congratulations, you have won the Supercoppa Italiana!")
              ...
              time.sleep(2)
              print(" ")
              print(f"Serie A Winner: {epl_winner}")
              print(f"Coppa Italia: {fa_winner}")
              print(f"Supercoppa Italiana: {carabao_winner}")
              print(" ")
